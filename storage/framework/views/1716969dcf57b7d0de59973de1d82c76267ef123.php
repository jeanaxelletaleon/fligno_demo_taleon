  ...
  <div class="container">    
     ...
     <div class="form-group">
          ...
          <div class="form-group">
              ...
              <input type="text" class="form-control" name="lastname" placeholder="Doe" value="<?php echo e($personal->lastname); ?>" disabled>
          </div>
           <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="phone" placeholder="Ex: 09123456789" value="<?php echo e($personal->gender); ?>" disabled>
...
<?php /**PATH C:\Users\Qing\practice_laravel\demo\resources\views/show.blade.php ENDPATH**/ ?>