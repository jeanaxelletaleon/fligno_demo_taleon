...
<div id="formModal" class="modal fade" role="dialog">
 <div class="modal-dialog">
  <div class="modal-content">
   <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Personal Information Record</h4>
        </div>
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                        <?php $__currentLoopData = $benefits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $benefit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <input type="checkbox" name="benefits[<?php echo e($benefit->id); ?>]" value="<?php echo e($benefit->id); ?>">
                            <?php echo e($benefit->type_of_benefit); ?>
...
$(document).ready(function(){
 ...
 $('#user_table').DataTable({
  ...
  serverSide: true,
  ajax:{
   url: "<?php echo e(route('index.index')); ?>",
  },
  columns:[
   {
    data: 'firstname',
 ...
 $('#sample_form').on('submit', function(event){
  ...
  if($('#action').val() == 'Add')
  {
    ...
    $.ajax({
    url:"<?php echo e(route('index.store')); ?>",
    method:"POST",
  ...
  {
   $.ajax({
    url:"<?php echo e(route('index.update')); ?>",
    method:"POST",
    data:new FormData(this),
    contentType: false,
    cache: false,
...
</script><?php /**PATH C:\xampp\htdocs\fligno_demo_taleon\resources\views/crud.blade.php ENDPATH**/ ?>